...
<div id="custom">
    <div id="loading_form_vn">
        <div class="custom_development">
            <h2>Заказать разработку</h2>
            <hr>
            <span>Хотите такой же красивый и функциональный интернет-магазин?
            Заполните форму обратной связи и мы в ближайшее время свяжемся 
            с указанным контактным лицом.</span>
        <button type="submit" name="iblock_submit" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>"> отправить </button>
        ...
        <div class="form_otpravka">
			...
			<?if($arParams["USE_CAPTCHA"] == "Y" && $arParams["ID"] <= 0):?>
				<span><?=GetMessage("IBLOCK_FORM_CAPTCHA_TITLE")?></span>
                <div> <input type="hidden" name="captcha_sid" value="<?=$arResult["CAPTCHA_CODE"]?>" />
